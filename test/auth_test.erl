...
invite() ->
    ...
    lager:notice("D1: ~p, D2: ~p", [DialogId1, DialogId3]),
...
dialog() ->
    ...
    {ok, 403, []} = nksip_uac:options(DialogId2, [{pass, {"invalid", "client1"}}]),
    {ok, 200, []} = nksip_uac:options(DialogId2, []),
    {ok, 200, []} = nksip_uac:options(DialogId2, [{pass, {"invalid", "client1"}}]),
