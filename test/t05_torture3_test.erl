...
%% Changed to TCP
application_12() ->
    nksip_registrar:delete(torture_test_server, sip, <<"watson">>, <<"example.com">>),
    Msg = 
        <<"REGISTER sip:example.com SIP/2.0\r\n"
...
application_14() ->
    nksip_registrar:delete(torture_test_server, sip, <<"user">>, <<"example.com">>),
    Msg = 
        <<"REGISTER sip:example.com SIP/2.0\r\n"
        "To: sip:user@example.com\r\n"
...
parse(Msg) ->
    case nksip_parse:packet(torture_test_server, #nkport{transp=udp}, Msg) of
        {ok, SipMsg, <<>>} -> SipMsg;
