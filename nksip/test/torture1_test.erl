...
valid_10_test() ->
    ...
    #sipmsg{
        vias = [
            ...
            #via{proto = tcp, domain = <<"t5.example.com">>, port = 0,
...
valid_12_test() ->
    Msg = 
        ...
        "a=rtpmap:31 LPC\r\n">>,
    #sipmsg{
        data = [{reason, <<"= 2**3 * 5**2 \xD0\xBD\xD0\xBE\x20\xD1\x81\xD1\x82\xD0\xBE\x20\xD0\xB4\xD0\xB5\xD0\xB2\xD1\x8F\xD0\xBD\xD0\xBE\xD1\x81\xD1\x82\xD0\xBE\x20\xD0\xB4\xD0\xB5\xD0\xB2\xD1\x8F\xD1\x82\xD1\x8C\x20\x2D\x20\xD0\xBF\xD1\x80\xD0\xBE\xD1\x81\xD1\x82\xD0\xBE\xD0\xB5">>}]
    } = parse(Msg),
    ok.
