...
basic() ->
    ...
    nksip_registrar:clear(server1, ?PACKAGE_CLASS_SIP),
        ...
        {ok, server1} ->
            ...
            case lists:member(Domain, [<<"127.0.0.1">>, <<"nksip">>]) of
                ...
                true when Domain =:= <<"nksip">> ->
                    case nksip_registrar:find(server1, ?PACKAGE_CLASS_SIP, Scheme, User, Domain) of
                        [] -> 
...
sip_options(Req, _Call) ->
    ...
    App = nksip_sipmsg:get_meta(srv_id, Req),
