...
sip_route(Scheme, User, Domain, Req, _Call) ->
    case nksip_request:srv_id(Req) of
        ...
        {ok, SrvId} when SrvId==server1; SrvId==server2; SrvId==server3 ->
...
sip_invite(Req, _Call) ->
    ...
    case nksip_request:body(Req) of
        {ok, Ops} when is_list(Ops) ->
            ...
            proc_lib:spawn(
                fun() ->
                    case nklib_util:get_value(SrvId, Ops) of
                        {redirect, Contacts} ->
                            Code = 300,
