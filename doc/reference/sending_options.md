...
You can use a number of options when [sending requests](../guide/sending_requests.md) using the [request sending functions](sending_functions.mdnksip_uac.erl)
