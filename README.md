...
**IMPORTANT** - See the [ROADMAP UPDATE](https://github.com/kalta/nksip/blob/master/doc/roadmap.md#update---update---update) for information on the future of NkSIP - **IMPORTANT**
